# spockito-junit4
Java JUnit 4.x runner for parameterized tests where the test cases are defined in a table-like manner. The @Unroll 
annotation has been inspired by the Groovy framework Spock.
